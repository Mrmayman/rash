...
pub fn compile() {
    ...
    for script in &code {
        ...
        let mut thread = compile_ir(func, &isa);
...
fn compile_ir(func: Function, isa: &Arc<dyn TargetIsa>) -> ScratchThread {
    ...
    ScratchThread::new(code.code_buffer())
}
